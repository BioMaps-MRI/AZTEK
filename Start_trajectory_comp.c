...
int main() {
    ...
    char argv[6][50];
    printf("Please enter separated by space (1) the number of spokes (2) AZTEK_Twist (3) AZTEK_Shuffle (4) AZTEK_Speed: ");
    ...
    return
        printf("Gradient amplitudes recorded in %s", gradListName);
        EXIT_SUCCESS; 
